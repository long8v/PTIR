...
## Details
- advantage r을 reference와의 비율로 두면 q가 정확히  exponential average of $r_\theta$ at step t가 됨 
...
즉 ORM을 학습할 때 r을 저렇게 주면 PRM처럼 각각의 step에 대한 $y_t$가 Q가 되어서 이걸 sparse reward처럼 사용할 수 있음
