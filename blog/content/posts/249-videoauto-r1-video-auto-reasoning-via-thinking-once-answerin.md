...
- The motivation stems from the finding that, upon evaluating benchmarks of trained video LLMs, the "direct" approach may yield better performance.
  - benchmarks
    - VideoMME 
- [VideoMMMU](https://arxiv.org/pdf/2501.13826): Lecture video. It is essentially very similar to the Text Reasoning Benchmark.
- [LongVideoBench](https://arxiv.org/pdf/2407.15754): Hmm, it's underperforming on LongVideoBench too.  => It seems the benchmark’s capabilities are primarily focused on perception and relationships. Also, looking at the models below, some of them don’t even have long videos in their training data.
